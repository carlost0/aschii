...
error_e print_scene(scene_t *scene, bool random);                              // prints specified scene to stdout, enabling random makes it print randomized characters instead of the specified ones in scene.screen
void    clear_screen();
